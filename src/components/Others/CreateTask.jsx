...
const CreateTask = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (!asignTo) {
      alert('Please select an employee before creating the task!')
      return
    }
    ...
    // ✅ Create new updated array — no mutation
    ...
    alert(`Task successfully assigned to ${asignTo}!`)
        ...
        <div className='w-1/2'>
          ...
          <div>
            ...
            <select
              ...
              className='text-sm py-1 px-2 w-4/5 rounded outline-none border border-gray-400 mb-4 bg-[#1c1c1c] text-white'
            >
